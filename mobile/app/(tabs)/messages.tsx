  ...
  return (
    <SafeAreaView className="flex-1 bg-white" edges={["top"]}>
      ...
      <View className="flex-row items-center justify-between px-4 py-3 border-b border-gray-100">
        ...
        <TouchableOpacity>
          <Feather name="edit" size={24} color="#3BAF56" />
        </TouchableOpacity>
      </View>
          ...
          <SafeAreaView className="flex-1">
            ...
            <View className="flex-row items-center px-4 py-3 border-b border-gray-100">
              <TouchableOpacity onPress={closeChatModal} className="mr-3">
                <Feather name="arrow-left" size={24} color="#3BAF56" />
              </TouchableOpacity>
              <Image
              ...
              <View className="flex-1">
                <View className="flex-row items-center">
                  ...
                  {selectedConversation.user.verified && (
                    <Feather name="check-circle" size={16} color="#3BAF56" />
                  )}
                </View>
                    ...
                    <View className={`flex-1 ${message.fromUser ? "items-end" : ""}`}>
                      <View
                        className={`rounded-xl px-4 py-3 max-w-xs ${
                          message.fromUser ? "bg-zoro" : "bg-gray-100"
                        }`}
                      >
            ...
            <View className="flex-row items-center px-4 py-3 border-t border-gray-100">
              ...
              <TouchableOpacity
                ...
                className={`size-10 rounded-full items-center justify-center ${
                  newMessage.trim() ? "bg-zoro" : "bg-gray-300"
                }`}
